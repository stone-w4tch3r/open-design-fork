...
real repo (cloned via `od-cli project import` or a path the user
...
| --- | --- | --- |
| `repoPath` | yes | Absolute path to the repo's root, supplied via `od-cli project import` or an upstream `od.context.assets[]` reference |
