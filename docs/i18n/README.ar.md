...
> يُشحَن Open Design على هيئة **مهارات وواجهة CLI وخادم MCP** تستهلكها وكلاء البرمجة السائدة بشكل أصلي. بمجرد تثبيت OD، يربط أمر واحد `od-cli mcp install <agent>` خادم MCP في إعدادات ذلك الوكيل، فتستدعي الأدوات نفسها من داخل أي وكيل.

| وكيل البرمجة / المنصة &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | الحالة &nbsp;&nbsp; | تثبيت خادم MCP بأمر واحد &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
|---|:---:|---|
| [Claude Code](https://docs.anthropic.com/en/docs/claude-code) | ✅ مدعوم | `od-cli mcp install claude` |
| [Codex CLI](https://github.com/openai/codex) | ✅ مدعوم | `od-cli mcp install codex` |
| [Cursor](https://www.cursor.com/cli) | ✅ مدعوم | `od-cli mcp install cursor` |
| [VS Code + GitHub Copilot](https://github.com/features/copilot) | ✅ مدعوم | `od-cli mcp install copilot` |
| [GitHub Copilot CLI](https://github.com/features/copilot/cli) | ✅ مدعوم | `od-cli mcp install copilot` |
| [Gemini CLI](https://github.com/google-gemini/gemini-cli) | ✅ مدعوم | `od-cli mcp install gemini` |
| [OpenCode](https://opencode.ai/) | ✅ مدعوم | `od-cli mcp install opencode` |
| [OpenClaw](https://github.com/openclaw/openclaw) | ✅ مدعوم | `od-cli mcp install openclaw` |
| [Antigravity](https://antigravity.google) | ✅ مدعوم | `od-cli mcp install antigravity` |
| [Cline](https://github.com/cline/cline) | ✅ مدعوم | `od-cli mcp install cline` |
| [Trae](https://www.trae.ai/) | ✅ مدعوم | `od-cli mcp install trae` |
| [Kimi CLI](https://github.com/MoonshotAI/kimi-cli) | ✅ مدعوم | `od-cli mcp install kimi` |
| [Pi Agent](https://github.com/badlogic/pi-mono) | ✅ مدعوم | `od-cli mcp install pi` |
| [Mistral Vibe CLI](https://github.com/mistralai/mistral-vibe) | ✅ مدعوم | `od-cli mcp install vibe` |
| [Hermes Agent](https://github.com/nousresearch/hermes-agent) | ✅ مدعوم | `od-cli mcp install hermes` |

`od-cli mcp install <agent> --print` لمعاينة تجريبية دون تنفيذ · `--uninstall` للإزالة · القائمة الكاملة عبر `od-cli mcp install --help`.
...
الإضافات على تكافؤ تام عبر **واجهة الويب** وواجهة **`od-cli` CLI** — نقاط نهاية `/api/plugins` نفسها، اختر ما يناسبك.
...
2. اجتز التحقق: `od-cli plugin validate` و`pnpm guard` و`pnpm --filter @open-design/plugin-runtime typecheck`.
...
- [ ] `npx od-cli init` لتهيئة مشروع بملف `DESIGN.md`
- [ ] SDK للإضافات + واجهة `od-cli plugin {add,list,remove,test,publish}` CLI
