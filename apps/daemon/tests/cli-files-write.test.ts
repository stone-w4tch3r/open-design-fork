// Red-spec for the `od-cli files write` / `od-cli files upload` crash:
...
describe('od-cli files write / upload (ESM require regression)', () => {
  let stub: StubServer;
  ...
  // but inside its own try/catch — so instead of crashing, `od-cli project create
