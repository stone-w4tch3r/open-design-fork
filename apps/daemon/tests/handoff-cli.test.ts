// Contract test for the `od-cli project handoff` CLI surface. Keeps the
...
describe('od-cli project handoff CLI', () => {
  let stdout: string[];
  let stderr: string[];
  ...
  // Malformed flags must reach this structured fail() path. `od-cli project
