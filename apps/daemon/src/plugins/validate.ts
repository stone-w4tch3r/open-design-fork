...
// DoctorReport shape the post-install `od-cli plugin doctor <id>`
// command emits.
//
// The lift from `od-cli plugin doctor`:
...
//
// Rationale: spec §16 Phase 4 ships `od-cli plugin scaffold`, `od-cli
// plugin export`, `od-cli plugin publish` for the author tooling slice.
// `od-cli plugin validate` closes the loop: the author can run lint
