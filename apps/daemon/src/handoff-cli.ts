// `od-cli project handoff` — the CLI surface for the resume-conversation
...
// the `od-cli` CLI as well as the web UI; both drive the same
...
const USAGE = `Usage:
  od-cli project handoff <projectId> --conversation <id> --api-key <key> --model <model>
