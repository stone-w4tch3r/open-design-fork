...
const residualAllowedExactPaths = new Set([
  ...
  // Checked-in bin shim so pnpm can link `od-cli` before daemon dist output exists.
...
const residualAllowedPathPrefixes = [
  "apps/daemon/dist/",
  // npm CLI distribution build artifacts (generated by build-for-publish.ts).
  "apps/daemon/resources/",
  "apps/web/.next/",
  "apps/web/out/",
  "generated/",
