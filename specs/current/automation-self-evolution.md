...
The packet should be inspectable in UI and available to `od-cli automation`.
...
|---|---|---|
| List templates | Automations template picker | `od-cli automation template list --json` |
| Run ingestion | Automations "Ingest source" panel | `od-cli automation source ingest --source-kind <kind> --body-file <path|-> --json` |
| Inspect source packets | Recent ingestions list | `od-cli automation source list/get --json` |
| Review proposals | Review drawer with diff and apply/reject | `od-cli automation proposal list/apply/reject --json` |
| Edit memory tree | Settings -> Memory tree | `od-cli memory tree ... --json` |
| Manage token compression | Ingestion compression selector | `od-cli automation source ingest --compression off|balanced|aggressive --json` |
| Promote design system | Evolution proposal apply action | `od-cli automation proposal apply <proposal> --json` |
| Crystallize skill | Evolution proposal apply action | `od-cli automation proposal apply <proposal> --json` |
...
- Add `od-cli memory tree list/view/edit/move` and matching Settings UI.
...
- `od-cli memory tree list/view/edit/move` mirrors the Settings memory-tree view so
...
- Update the existing Automations page and `od-cli automation` commands to present
...
- `od-cli automation proposal list/get/apply/reject` mirrors the UI review path.
...
- `od-cli automation source ingest/list/get` mirrors the Automations source panel.
